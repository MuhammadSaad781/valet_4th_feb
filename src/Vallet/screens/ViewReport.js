    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.inputbox}>
          <Text style={styles.title2}>Texas </Text>
        </View>
        <Text style={styles.title}>City </Text>
        <View style={styles.inputbox}>
          <Text style={styles.title2}>El Paso </Text>
        </View>
        <Text style={styles.title}>Property </Text>
        <View style={styles.inputbox}>
          <Text style={styles.title2}>Lake Fairway </Text>
        </View>
        <Text style={styles.title}>Apartment # (optional)</Text>
        <View style={styles.inputbox}>
          <Text style={styles.title2}>22-A</Text>
        </View>
        ...
        <View style={styles.imagebutton}>
          ...
          >
            ...
            <View style={styles.textitem}>
              <Text style={{ fontFamily: "CircularStd" }}>Capture.PNG</Text>
            </View>
          </View>
